...
export default function HomeScreen() {
  ...
  return (
    <View style={styles.container}>
      ...
      {/* Ombrage dégradé en bas pour une meilleure lisibilité */}
      <LinearGradient
        colors={['transparent', 'rgba(0,0,0,0.85)']}
        style={styles.bottomGradient}
      />

      {/* Section Informations Vidéo & Musique (Bas Gauche) */}
      <View style={styles.videoInfo}>
        <Text style={styles.username}>@amenia_nova</Text>
        <Text style={styles.description} numberOfLines={2}>
          Bienvenue sur la version enrichie de NOVA ! 🚀 #Duo #Filtres #Live3D
        </Text>
        
        {/* Ligne Audio / Musique Originale */}
        <TouchableOpacity style={styles.musicRow} activeOpacity={0.7}>
          <Ionicons name="musical-notes" size={14} color="#FF2D55" style={{ marginRight: 6 }} />
          <Text style={styles.musicText} numberOfLines={1}>Son original - @amenia_nova</Text>
        </TouchableOpacity>
      </View>
      ...
      <View style={styles.actionBar}>
        ...
        <View style={styles.actionItem}>
          ...
          <Text style={styles.actionText}>Duo</Text>
        </View>
